const Produto = require("../../models/products/ProdutoModel");
const Categoria = require("../../models/categories/CategoriaModel");
const Fornecedor = require("../../models/providers/FornecedorModel");
