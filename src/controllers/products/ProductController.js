const Produto = require("../../database/models/products/ProductModel");
const Categoria = require("../../database/models/categories/CategoryModel");
const Fornecedor = require("../../database/models/providers/ProviderModel");
